        ...
        <div id="signup-inner">
        	...
        	<div class="clearfix" id="header">
        		...
        		<img id="signup-icon" src="./images/logo_img.gif" alt="" />
                        ...
                        <h1 style="margin-left: 55px; font-size: 36px;color: slateblue;">File Access Control</h1>
            ...
            <p>
                ...
                <select id="keys" name="key1" style="width: 320px; height: 30px;" onchange="loadXMLDoc()"> 
                ...
                <select id="keys" name="key2" style="width: 320px; height: 30px;" onchange="loadXMLDoc()"> 
                                        <option value="-1">-Select-</option>
                ...
                <select id="keys" name="key3" style="width: 320px; height: 30px;" onchange="loadXMLDoc()"> 
                                        <option value="-1">-Select-</option>
                ...
                <p>
                    ...
                    <button id="submit" type="submit" style="margin-left: 120px;" >Submit</button>
                </p>
