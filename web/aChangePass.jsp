          ...
          <p>
              ...
              %>
               ...
               <p>
                   ...
                   <input type="text" name="name" style="margin-left:130px;font-size: 29px;" value="<%=name%>"READONLY/>
               </p> 
              
               <p>
                <label for="name" style="font-size: 25px;">Old PassWord</label>
                &nbsp;<input type="text" name="pass" style="margin-left:35px;font-size: 29px;  " value="<%=pass%>" readonly/>
                </p> 
               <p>
                <label for="name"style="font-size: 25px;">New password </label>
                &nbsp;<input type="text" name="newp" style="margin-left:35px;font-size: 29px;  "/>
                </p> 
               <p>
                <label for="name"style="font-size: 25px;">Conf. Password</label>
                &nbsp;<input type="text" name="conp" style="margin-left:28px;font-size: 29px;  " />
