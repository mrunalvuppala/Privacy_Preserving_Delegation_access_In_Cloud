...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 style="font-size: 50px;">ADD Server Details</h2>
          <div class="clr"></div>
          <p>
              ...
              %>
               ...
               <p>
                   <label for="name" style="font-size: 35px;">Host Name  </label>
                   <input type="text" name="host" style="margin-left:45px;font-size: 29px;" />
               </p> 
              
               <p>
                <label for="name" style="font-size: 35px;">UserName</label>
                &nbsp;<input type="text" name="name" style="margin-left:53px;font-size: 29px;  "/>
                </p> 
               <p>
                <label for="name"style="font-size: 35px;">PassWord</label>
                &nbsp;<input type="text" name="pass" style="margin-left:54px;font-size: 29px;  "/>
                </p> 
               
               
                <p>
                    <input type="submit" style="margin-left:175px;font-size: 21px;" value="ADD Server"/>
                </p>
                </form>
          </p>
        </div>
