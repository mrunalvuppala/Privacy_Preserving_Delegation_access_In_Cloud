    ...
    <div class="content_resize">
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="UprofileView.jsp">Profile</a></li>
            <li><a href="UserEProfile.jsp">Edit Profile</a></li>
            <li><a href="download.jsp">File Download</a></li>
            <li><a href="UfileDetails.jsp">File Details</a></li>
            <li><a href="Utrans.jsp">Transactions</a></li>
            <li><a href="HomePage.jsp">LogOut</a></li>
          </ul>
        </div>
