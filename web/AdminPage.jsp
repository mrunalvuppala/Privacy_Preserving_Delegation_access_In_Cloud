    ...
    <div class="content_resize">
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="AprofileView.jsp">Profile</a></li>
            <li><a href="editProfile.jsp">Edit Profile</a></li>
            <li><a href="aChangePass.jsp">Change Password</a></li>
            <li><a href="addServer.jsp">Cloud Server</a></li>
            <li><a href="ServerDetails.jsp">Cloud Server Details</a></li>
            <li><a href="adDataOwner.jsp">Add Data Owner</a></li>
            <li><a href="onwerDetails.jsp">Data Owner Detail</a></li>
            <li><a href="Domain.jsp">Add Domain</a></li>
            <li><a href="subDomain.jsp">Add Sub Domain</a></li>
            <li><a href="HomePage.jsp">LogOut</a></li>
          </ul>
        </div>
