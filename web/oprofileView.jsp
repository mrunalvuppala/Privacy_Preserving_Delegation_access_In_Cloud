...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 style="font-size: 50px;"><span>Owner </span> Profile</h2>
          <div class="clr"></div>
          <p>
              <%
              String ID = session.getAttribute("ownerUid").toString();
              System.out.println("ID "+ID);
              String name=null,pass=null,email=null,mob=null,addr=null;
                Connection c = DbConnector.getConnection();
                Statement s = c.createStatement();
                ResultSet r = s.executeQuery("select * from adowner where name = '"+ID+"'  ");
                if (r.next()){
              ...
              %>
               ...
               <label for="name"style="margin-left:36px;font-size: 29px;  ">::&nbsp;<%=name%></label>
                </p> 
               <p>
                <label for="name" style="font-size: 35px;">PassWord</label>
                <label for="name"style="margin-left:45px;font-size: 29px;  ">::&nbsp;<%=pass%></label>
                </p> 
               <p>
                <label for="name"style="font-size: 35px;">Mail Id</label>
               <label for="name"style="margin-left:105px;font-size: 29px;  ">::&nbsp;<%=email%></label>
                </p> 
