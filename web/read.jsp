...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    %>
        <div class="main">
            ...
            <div id="tabs" style="">
                <ul>
                    <li><a href="#tabs-3"><strong>File Details</strong></a></li>
                </ul>
                ...
                <table  style="width:90%;position:absolute;">
                    <tr bgcolor="#68B8DF" style="font-family:verdana;font-size:12px;">
                        <td height="40"><strong> <center>File Name </center></strong></td></tr>
                <%
