...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 style="font-size: 50px;">ADD Data Owner</h2>
          <div class="clr"></div>
          <p>
              ...
              %>
               ...
               <p>
                ...
                &nbsp;<input type="text" name="pass" style="margin-left:53px;font-size: 29px;  "/>
                </p> 
               <p>
                <label for="name"style="font-size: 35px;">E-Mail</label>
                &nbsp;<input type="text" name="mail" style="margin-left:114px;font-size: 29px;  "/>
                </p> 
               
               
                <p>
                    <input type="submit" style="margin-left:175px;font-size: 21px;" value="ADD Owner"/>
                </p>
                </form>
          </p>
        </div>
