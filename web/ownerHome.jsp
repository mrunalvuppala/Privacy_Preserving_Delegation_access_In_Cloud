    ...
    <div class="content_resize">
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="oprofileView.jsp">Profile</a></li>
            <li><a href="ownerEProfile.jsp">Edit Profile</a></li>
           ...
           <!-- <li><a href="req.jsp">View User Request</a></li> -->
            ...
            <li><a href="FileAccessControl.jsp">File Access Control</a></li>
            <li><a href="SendResponse.jsp">Transactions</a></li>
            <li><a href="HomePage.jsp">LogOut</a></li>
          </ul>
        </div>
